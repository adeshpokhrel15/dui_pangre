    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Hero(
              tag: widget.vItem.itemImg.toString(),
              child: Container(
                height: (screenHeight / 2) + 70.0,
                width: screenWidth,
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(widget.vItem.itemImg.toString()),
                        fit: BoxFit.cover)),
              )),
          Positioned(
              top: 35.0,
